...
@AutoAdd.Ignore
public class BoomingBlade extends AbstractEasyCard {
    public static final String ID = makeID(BoomingBlade.class.getSimpleName());
    ...
    public BoomingBlade(AbstractMonster target) {
        super(ID, COST, TYPE, RARITY, TARGET, COLOR);
        Target = target;
        baseDamage = DAMAGE;
        block = baseBlock = 7;
