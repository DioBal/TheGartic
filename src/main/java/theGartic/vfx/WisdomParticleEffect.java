...
public class WisdomParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public WisdomParticleEffect() {
        this.duration = MathUtils.random(0.6F, 1.0F);
        this.scale = MathUtils.random(0.6F, 1.2F) * Settings.scale;
        this.dur_div2 = this.duration / 2.0F;
        this.color = new Color(MathUtils.random(0.2F, 0.3F), 1.0F,  MathUtils.random(0.65F, 0.8F), 0.0F);
